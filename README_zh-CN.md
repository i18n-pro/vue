...
[English](https://github.com/i18n-pro/vue/tree/v0.1.0-alpha.5#readme) | 简体中文
...
* 当前库
   * [快速上手](https://github.com/i18n-pro/vue/blob/v0.1.0-alpha.5/docs/dist/USAGE_zh-CN.md)
   * [API](https://github.com/i18n-pro/vue/blob/v0.1.0-alpha.5/docs/dist/API_zh-CN.md)
   * [更新日志](https://github.com/i18n-pro/vue/blob/v0.1.0-alpha.5/docs/dist/CHANGELOG_zh-CN.md)
* i18n-pro
