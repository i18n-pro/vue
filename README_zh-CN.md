...
[English](https://github.com/i18n-pro/vue/tree/v2.0.0-alpha.2#readme) | 简体中文
...
![demo](https://s3.bmp.ovh/imgs/2025/07/11/5b5ef272599ccbe3.gif)
...
* with$ = true
   ...
   * [![Open in StackBlitz](https://developer.stackblitz.com/img/open_in_stackblitz_small.svg "Open in StackBlitz")](https://stackblitz.com/github/i18n-pro/vue-demo/tree/main?file=README_zh-CN.md)
* with$ = false
...
* 当前库
   * [快速上手](https://github.com/i18n-pro/vue/blob/v2.0.0-alpha.2/docs/dist/USAGE_zh-CN.md)
   * [API](https://github.com/i18n-pro/vue/blob/v2.0.0-alpha.2/docs/dist/API_zh-CN.md)
   * [更新日志](https://github.com/i18n-pro/vue/blob/v2.0.0-alpha.2/docs/dist/CHANGELOG_zh-CN.md)
* i18n-pro
